...
from saluki.models.datafiles import create_datafile, update_datafile, remove_datafile, list_datafiles, list_datafile
from saluki.schemas.datafiles import DataFileCreate, DataFileUpdate, DataFileInDB, DataFile
from saluki.dependencies.database import get_database

datafile_router = APIRouter(
    prefix="/datafiles",
    tags=["datafiles"],
    responses={404: {"description": "Data File not found"}, 403: {"description": "Insufficient permissions"}},
)
...
@datafile_router.put("/{datafile_id}", response_model=DataFile, status_code=status.HTTP_200_OK)
